...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'donate.hero.title2': '捐赠计划',
    'donate.hero.desc': '体验专业交易员训练，帮助我们为更多优秀年轻人提供免费训练支持',
    'donate.hero.stat1': '试用期',
    'donate.hero.stat2': '教练陪跑',
    'donate.hero.stat3': '晋级机会',
    'donate.hero.stat1.value': '30~90天',
    'donate.hero.stat2.value': '全程',
    'donate.hero.stat3.value': '最高获得终身',

    'donate.amount.badge': '标准捐赠会员',
    'donate.amount.warning': '默认以加密货币捐赠，其他方式请在邮件中说明',
    'donate.amount.start': '试用期',
    'donate.amount.daily': '每日增长',
    'donate.amount.payment': '晋级机会',
    'donate.amount.crypto': '终身',

    'donate.benefits.title': '试用会员权益',
    'donate.benefits.desc': '标准化专业培训，开启职业交易员之路',
    ...
    'dashboard.preparation.part4.button': '团队教练告知已激活，已收到模拟账户',
    'dashboard.preparation.part5.title': '完成激活',
    'dashboard.preparation.part5.step7': '团队长回复系统已激活后，再次双击"交易系统.exe"安装。确认个人信息与之前填写的相同，再次点击"试用"。',
    'dashboard.preparation.part5.step8': '提示"MT4指标等已安装成功"即可。桌面会新增一个"交易模板"图标',
    'dashboard.preparation.part5.step9': '双击桌面"交易模板"图标，填写团队教练提供的模拟账户，密码，正确选择对应服务器进行登录。',
    'dashboard.preparation.part5.step10': '解压缩"模板.zip"文件，复制里面的"MQL4"和"templates"两个文件夹',
    'dashboard.preparation.part5.step11': '打开交易系统客户端左上角选择"文件"——"打开数据文件夹"，把两个文件夹粘贴进去，如果提示覆盖，选"是"。',
    'dashboard.preparation.part5.step12': '关闭交易系统，重新通过桌面"交易模板"图标打开，尝试加载模板，看是否正常显示。',
    'dashboard.preparation.part5.step13': '模板加载方式：在你的交易品种图表上右键——模板——选择"3号+模板"或者"3号模板"，应该清晰显示红折线，蓝折线，三青线，止损线等指标',
    'dashboard.preparation.part5.note': '提示：以后都要从"交易模板"图标进入交易系统，不要从"Tickmill"图标进入，否则模板可能无法正常显示。',
    'dashboard.footer.warning': ' 仅用于测试环境。实盘交易需要充分测试和风险评估。',
    'dashboard.footer.copyright': '2024-2025 © GrowingPool 专业外汇交易员培训平台',

    // 通知管理
    'notification.manage.title': '管理员操作',
    'notification.manage.myNotifications': '我的通知管理',
    'notification.manage.allUsersNotifications': '所有用户通知管理',
    'notification.manage.deleteOld': '清空旧通知',
    'notification.manage.deleteAll': '清空所有通知',
    'notification.manage.deleteOldAllUsers': '清空所有用户旧通知',
    'notification.manage.deleteAllAllUsers': '清空所有用户通知',
    'notification.manage.daysPlaceholder': '天数',
    'notification.manage.deleteOldConfirm': '确定要清空 {days} 天前的所有通知吗？',
    'notification.manage.deleteAllConfirm': '确定要清空所有通知吗？此操作不可撤销！',
    'notification.manage.deleteOldAllUsersConfirm': '确定要清空所有用户 {days} 天前的通知吗？这将影响所有用户！',
    'notification.manage.deleteAllAllUsersConfirm': '确定要清空所有用户的所有通知吗？此操作不可撤销，将影响所有用户！',
    'notification.manage.deleting': '删除中...',
    'notification.manage.success': '通知清空成功',
    'notification.manage.successAllUsers': '所有用户通知清空成功',
    'notification.manage.error': '清空通知失败',
    'notification.manage.lastDays': '过去 {days} 天',
    'notification.manage.allTime': '所有时间',
  ...
  en: {
    ...
    'donate.amount.warning': 'Fixed donation amount, no additional fees',
    ...
    'dashboard.preparation.part4.button': 'Team coach confirms activation, demo account received',
    'dashboard.preparation.part5.title': 'Complete Activation',
    'dashboard.preparation.part5.step7': 'After team leader confirms system activation, double-click "交易系统.exe" again. Confirm personal information matches, click "Trial" again',
    'dashboard.preparation.part5.step8': 'Prompt "MT4 indicators installed successfully". A new "Trading Template" icon will appear on desktop',
    'dashboard.preparation.part5.step9': 'Double-click desktop "Trading Template" icon, enter demo account provided by coach, password, and select correct server to login',
    'dashboard.preparation.part5.step10': 'Extract "模板.zip" file, copy "MQL4" and "templates" folders',
    'dashboard.preparation.part5.step11': 'Open trading client, select "File" -> "Open Data Folder", paste the two folders. Select "Yes" if prompted to overwrite',
    'dashboard.preparation.part5.step12': 'Close trading system, reopen via desktop "Trading Template" icon, try loading templates to check if they display properly',
    'dashboard.preparation.part5.step13': 'Template loading method: Right-click on your trading instrument chart -> Template -> Select "3号+模板" or "3号模板". You should clearly see red broken lines, blue broken lines, three green lines, stop loss lines and other indicators',
    'dashboard.preparation.part5.note': 'Note: Always enter the trading system via the "Trading Template" icon, not the "Tickmill" icon, otherwise templates may not display properly',
    ...
    // 通知管理
    'notification.manage.title': 'Admin Actions',
    'notification.manage.myNotifications': 'My Notifications Management',
    'notification.manage.allUsersNotifications': 'All Users Notifications Management',
    'notification.manage.deleteOld': 'Clear Old Notifications',
    'notification.manage.deleteAll': 'Clear All Notifications',
    'notification.manage.deleteOldAllUsers': 'Clear Old Notifications for All Users',
    'notification.manage.deleteAllAllUsers': 'Clear All Users Notifications',
    'notification.manage.daysPlaceholder': 'Days',
    'notification.manage.deleteOldConfirm': 'Are you sure you want to clear all notifications from {days} days ago?',
    'notification.manage.deleteAllConfirm': 'Are you sure you want to clear all notifications? This action cannot be undone!',
    'notification.manage.deleteOldAllUsersConfirm': 'Are you sure you want to clear notifications from {days} days ago for ALL users? This will affect all users!',
    'notification.manage.deleteAllAllUsersConfirm': 'Are you sure you want to clear ALL notifications for ALL users? This action cannot be undone and will affect all users!',
    'notification.manage.deleting': 'Deleting...',
    'notification.manage.success': 'Notifications cleared successfully',
    'notification.manage.successAllUsers': 'All users notifications cleared successfully',
    'notification.manage.error': 'Failed to clear notifications',
    'notification.manage.lastDays': 'Last {days} days',
    'notification.manage.allTime': 'All time',
