...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'hero.subtitle': '多资产管理与交易人才培养专家',
    'hero.cta.learn': '免费交易训练',
    'hero.cta.dashboard': '管理人控制台',

    // Why Choose Section
    'why.title': '为什么选择生金池',
    'why.subtitle': '专业筛选和培养顶尖交易员，为多资产配置时代做好准备',

    // Advantages
    'advantage.selection.title': '精准筛选',
    'advantage.selection.desc': '30个交易日内判断你是否适合多资产交易，节省时间。不适合我们会如实告知，适合则全力培养。',
    'advantage.growth.title': '快速成长',
    'advantage.growth.desc': '专业的标准化培养计划，让合适人选在30个交易日内达到专家级投机交易水平，这对个人学习者来说往往需要10-20年的时间。',
    'advantage.commission.title': '共同管理',
    'advantage.commission.desc': '优秀的交易员将与我们一同管理多资产组合，并随管理规模变化，提供多阶段的丰厚的奖学金',
    ...
    'comparison.practical': '实战培养 - 30交易日系统化职业训练',
    'comparison.selection': '精准筛选 - 只接受特定人群，不适合直接劝退，节省时间',
    'comparison.funding': '机会支持 - 通过考核后为我们管理资产组合',
    'comparison.share': '丰厚奖励 - 提供多阶段奖学金',
    'comparison.career': '职业发展 - 培养独立交易员或基金管理人',
    'comparison.discipline': '严格纪律 - 专业化管理，培养职业素养',
    ...
    'comparison.emphasis': '我们致力于用最短的时间，从大量人群中，筛选出少数适合做多资产交易的人才，进行培养并给予全面支持',

    // Career Path
    'career.title': '职业发展路径',
    'career.subtitle': '30个交易日系统化培养，从新手到职业交易员的完整路径',
    ...
    'career.stage3.success': ' 通过考核进入小额账户稳定性测试阶段',
    'career.stage4.path': '小额账户  大额矩阵',
    'career.stage4.title': '职业交易员',
    'career.stage4.desc': '20个交易日小额账户稳定性测试通过后，可选择进入大额矩阵',
    ...
    'cta.subtitle': '记住：最大风险是淘汰，成本是时间。准备就绪，预约面试。通过后，入训。',
    ...
    // Footer
    'footer.about': '专注于多资产投机交易的职业交易员培训平台，用专业的方法筛选和培养真正适合的交易人才。',
    ...
    'footer.copyright': '© 生金池 · 多资产管理与交易人才培养 · growingpool.com',
    ...
    // Join Us Page
    'joinus.hero.badge': '专业化交易员训练',
    'joinus.hero.title1': '生金池',
    'joinus.hero.title2': '交易员培训',
    'joinus.hero.subtitle': '专业筛选和培养顶尖交易员，为多资产配置时代做好准备',
    ...
    'joinus.welcome.desc': '与传统机构不同，我们希望在资产得到严格风控和妥善管理的前提下，给予我们的成员尽可能高的自由度。世界上的任何地方，你都可以随心所欲，在阿尔卑斯山滑雪，夏威夷游泳或北海道发呆……金钱会源源不断地自动流入你的口袋。从你通过考核那一天起，你就可以遨游在世界的任何一个角落，旅行、生活或工作，哪怕是漫无目的的活着；既不需要为日常的琐事烦恼，也不需要看任何人的脸色行事，自由自在心无旁骛的同时，尽可能地把生命旅程延展……',

    'joinus.about.title': '关于我们',
    'joinus.about.desc1': '我们是一个专注于多资产交易和培养顶尖交易员的组织，我们致力于用最短的时间从大量人群中筛选出少数适合成为交易员的人才并进行培养并给予全周期支持。',
    ...
    'joinus.about.timeline': '我们将在 30个交易日(约25个自然日) 内判断新人是否是做交易员的可塑之才：',
    ...
    'joinus.about.fit.desc': '我们会为其分配账户，以独立交易员的身份为起点，将其招募进我们的组织',
    ...
    'joinus.profile.unsuited': '在交易的世界里，有些人天生不适合。他们急于求成，却不知自己真正追求什么；他们只瞥一眼表象，便止步不前，无法洞察事物的深层本质；或者，他们压根就该选择那些"稳定"的岗位——当一天和尚，敲一天钟，过着可预测的日子。这不是贬低，而是现实：交易如战场，需要冷静、洞察与韧性。如果你属于这一类，或许其他行业更能发挥你的长处。',
    ...
    'joinus.profile.basic.4': '个人Windows系统设备，独立不受打扰的交易环境',
    ...
    'joinus.plan.phase1.warning': ' 重要：5 个交易日不能完成规则考核，酌情劝退处理',
    ...
    'joinus.plan.phase3.desc': '这是最终考核阶段，需要连续10个交易日保持稳定盈利',
    'joinus.plan.phase3.req': '盈利考核要求：连续 10 个交易日，每天做到所选交易品种不错单、不漏单、不亏损',
    'joinus.plan.phase3.warning': ' 重要：30个交易日内不能完成连续 10 天盈利，劝退处理',
    ...
    'joinus.plan.phase5.desc': '小额实盘 20 交易日稳定性测试通过，进入大额矩阵',
    ...
    'joinus.final.p1': '我们这是交易员军队训练营，在这里，我们将严格按照军事管理的方式将你训练成正规军（通过考核）。通过考核之后，我们将给你发放枪支弹药，让你去前线作战（实盘交易）并胜利凯旋（盈利而归）。',
    'joinus.final.p2': '所以，我们会非常认真训练你们，因为没有一个将军希望牺牲自己辛苦训练出来的战士（不能盈利的交易员不可能去往前线）。',
    'joinus.final.p3': '通过考核后，我们就是合作共赢的关系。你可以选择独立作战，也可以选择和战友背靠背作战，我们不是公司员工隶属的关系，你是一个独立的创业者，独立的个体。',
    'joinus.final.highlight': '起始 50% 利得会奖励给你个人，对于最优秀的交易员，将单独设计奖励计划',
    'joinus.final.p4': '因为这是窄门，你难道没有听说过免费的也许会是比钱更"贵"的？第一，你下决定决心并且被选中，一旦开始职业交易训练，请全身心投入。',
