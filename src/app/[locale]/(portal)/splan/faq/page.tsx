  ...
  if (language === 'zh') {
    return {
      course: [
        ...
        {
          question: '为什么筛选如此严格？',
          answer: '我们的理念是<strong>培养真正适合的人，留下极少数，劝返大多数</strong>。在交易的世界里，有些人天生不适合。我们用严格的筛选机制确保只有真正适合的人才能进入。这不是贬低，而是对每个人负责。'
        },
        {
        ...
        {
          question: '通过考核的概率有多大？',
          answer: '根据历史数据，通过考核的概率<strong> &lt; 15%</strong>。但对你而言，要么是1%，要么是99%。这取决于你是否真正适合做交易，是否严格遵守纪律，是否能承受压力并保持情绪稳定。'
        }
      ],
      learning: [
        {
        ...
        {
          question: '需要什么样的基础条件？',
          answer: '<ul><li>大专学历以上，35岁以下</li><li>认真、细心、耐心、心理健康</li><li>连续30个交易日可投入</li><li>Windows电脑，独立的交易环境</li><li>周一到周五，每天最低保证 13:30 - 21:30 在线</li><li>休息日参照芝加哥商品交易所（CME）非交易时段</li></ul>'
        },
        {
        ...
        },
        {
          ...
          answer: '通过考核后，我们会为你分配账户：<ul><li><strong>小额实盘</strong>：100美金</li><li><strong>大额实盘</strong>：根据小额实盘表现设定</li><li><strong>奖励比例</strong>：50%+（随能力提升而提高）</li><li><strong>完全自由</strong>：不受时间空间限制，可以在世界任何角落工作</li></ul>'
        },
        {
          question: '学习过程中可以提问吗？',
      ...
      pricing: [
        ...
        },
        {
          ...
          answer: '你在战场获得的战利品，<strong>至少 50%奖励属于你个人</strong>，随着你的能力提升，这个比例也会随之提高，<strong>优秀交易员单独定制奖励方案</strong>。剩下的属于我们，所以我们会用心培养每一位准交易员——你战场战利品多，我们战利品也才会多，荣辱与共！'
        },
        {
      ...
      support: [
        ...
        },
        {
          ...
          answer: '如果在30个工作日内，我们判断你不适合做交易，会如实告知，并<strong>建议不要再踏足二级市场</strong>。这不是侮辱，而是保护。不适合的人进入二级市场，最终知会亏损累累。我们希望能避免这个结局。'
        }
      ],
      other: [
        {
