...
const getFAQData = (language: 'zh' | 'en'): FAQData => {
  if (language === 'zh') {
    return {
      course: [
        {
          question: '什么是 生金池GrowingPool 交易员培训？',
          answer: '我们是一个专注于多资产交易和培养顶尖交易员的组织，我们致力于用最短的时间从大量人群中筛选出少数适合成为交易员的人才并进行培养并给予全周期支持。我们将在<strong> 30个工作日</strong>内判断新人是否是做交易的可塑之才。通过考核者将获得资金支持，成为独立交易员或基金管理人。'
        },
        {
          question: '为什么筛选如此严格？',
          answer: '我们的理念是<strong>寻找同频的少数人</strong>。在交易的世界里，有些人天生不适合。我们用严格的筛选机制确保只有真正适合的人才能进入。这不是贬低，而是对每个人负责。'
        },
        {
          question: '30个工作日会学习什么？',
          answer: '<strong>第1-3天</strong>：完成规则练习，熟悉交易系统基本规则（15个标准进场点不出错）<br/><strong>第3-20天</strong>：盈利练习，找到适合自己的品种，要求连续10个工作日不错单、不漏单、不亏损<br/><strong>第20-40天</strong>：小额实盘训练（如通过盈利考核）<br/>训练期限前不能完成考核，将被劝退。'
        },
        {
          question: '为什么只有一次机会？',
        ...
        {
          question: '通过考核的概率有多大？',
          answer: '根据历史数据，通过考核的概率<strong> &lt; 15%</strong>。但对你而言，要么是0%，要么是100%。这取决于你是否真正适合做交易，是否严格遵守纪律，是否能承受压力并保持情绪稳定。'
        }
      ],
      learning: [
        {
        ...
        {
          question: '需要什么样的基础条件？',
          answer: '<ul><li>中国大陆大学专科或同等学历以上，年龄在35岁以下</li><li>认真、细心、耐心、心理健康</li><li>连续30个交易日可投入训练</li><li>Windows电脑，独立的交易环境</li><li>周一到周五，每天最低保证 13:30 - 21:30 在线</li><li>休息日参照芝加哥商品交易所（CME）非交易时段</li></ul>'
        },
        {
          question: '5天不能完成规则考核会怎样？',
          answer: '5天不能完成规则考核，将<strong>酌情终止训练</strong>。我们的筛选机制非常严格，如果连基本规则都无法快速掌握，说明可能不适合这个行业。这是为了保护你，避免浪费更多时间。'
        },
        {
          question: '通过考核后可以获得什么？',
          answer: '通过考核后，我们会为你分配账户：<ul><li><strong>小额实盘</strong>：100美金起</li><li><strong>大额矩阵</strong>：根据小额实盘表现设定</li><li><strong>奖励比例</strong>：60%+（随管理规模提升而提高）</li><li><strong>完全自由</strong>：不受时间空间限制，可以在世界任何角落工作</li></ul>'
        },
        {
          question: '学习过程中可以提问吗？',
          answer: '可以。我们有在线答疑会议室，可以直接语音与团队长沟通。其他时间可以通过你添加的联系方式与团队长联系。但请注意：<strong>学员之间不得加微信、电话等联系方式</strong>，这是纪律红线。'
        }
      ],
      pricing: [
        {
          question: '关于收入、社保、底薪和薪资结构',
          answer: '任何盈利导向的企业，都不会做亏本买卖。在我们这个极简行业，所有价值都源于二级市场的买卖差价——简单、直接、残酷。<strong>在你证明盈利能力（通过考核）之前，我们不会投入一分钱。</strong>考核通过后，你所获得的奖励，也不会大于你在交易上产生的利润"。'
        },
        {
          question: '通过考核后的收入分配如何？',
          answer: '你在交易商上产生的利润，<strong>至少60%奖励给你个人</strong>，随着你的能力提升，这个比例也会随之提高，<strong>优秀交易员单独定制奖励方案</strong>。剩下的属于我们，所以我们会用心培养每一位合格交易员——你的战利品多，我们战利品也才会多，荣辱与共！'
        },
        {
        ...
        {
          question: '为什么不需要付学费？',
          answer: '跟传统学科不同，不需要你付出数万美金的"学费"，毕竟这是一个钱生钱的行业。我们的模式是：我们培养你，你通过后我们分享你的战果。这是一种<strong>合作共赢</strong>的关系，而非雇佣关系。你是一个独立的创业者，独立的个体。'
        }
      ],
      support: [
        {
          question: '什么是交易铁律？',
          answer: '交易纪律就像法律法规，触碰一次就会被标上不信任的标签。<strong>一旦触碰，就无法进入矩阵团队；第二次触碰红线，直接劝退离开团队。</strong>交易就像做手术，务必严肃，容不得任何不遵守规则的人。'
        },
        {
          question: '交易规则红线有哪些？',
        ...
        },
        {
          ...
          answer: '如果在30个工作日内，我们判断你不适合做交易，会如实告知，并<strong>立即终止训练</strong>。这不是侮辱，而是保护。不适合的人进入二级市场，最终只会亏损累累。我们希望能避免这个结局。'
        }
      ],
      other: [
        {
          question: '为什么说"年轻人更适合"？',
          answer: '国内多数"经验丰富"的中年交易员，往往是失败者：不良习惯缠身，或在不上不下的泥沼中挣扎。<strong>经验有时是枷锁，而非利剑。</strong>真正适配的是20-35岁的年轻人：学习迅捷、适应力强，能直面市场风暴。我们计划在30个工作日内，让年轻人直达那些"专家"10-20年的交易水平。'
        },
        {
          question: '交易有风险吗？',
        ...
        },
        {
          ...
          answer: '不建议。培训要求<strong>连续30个工作日</strong>，周一到周五每天最低保证 13:30 - 21:30 在线。这是全职投入的筛选和培养过程。如果无法保证时间投入，建议不要申请，因为这会浪费双方的时间。'
        },
        {
    ...
    return {
      course: [
        {
          question: 'What is GrowingPool Forex Trader Training?',
