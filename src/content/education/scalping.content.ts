...
export const scalpingContent = {
  zh: {
    title: '剥头皮交易完整指南 - Scalping超短线策略与快速执行技巧 | GrowingPool',
    ...
    ctaTitle: '想要学习专业交易策略？',
    ctaDescription: '加入 GrowingPool 培训计划，从基础策略开始系统学习',
  ...
  en: {
    title: 'Complete Scalping Guide - Ultra-Short-Term Strategies and Fast Execution | GrowingPool',
    ...
    ctaDescription: 'Join GrowingPool training to systematically learn from foundational strategies',
